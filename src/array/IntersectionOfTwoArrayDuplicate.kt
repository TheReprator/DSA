...
fun main() {
    //val intersection = intersectionDuplicate(intArrayOf(1,2,2,1), intArrayOf(2,2))
    val intersection = intersectionDuplicate(intArrayOf(4,9,5), intArrayOf(9,4,9,8,4))
    println(intersection.joinToString())
}
fun intersectionDuplicate1(nums1: IntArray, nums2: IntArray): IntArray {
...
fun intersectionDuplicate(nums1: IntArray, nums2: IntArray): IntArray {
